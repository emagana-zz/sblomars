...
public class NetworkLevel_Client {
	...
	public void gettingResourceMaganagerData (String config) {
		...
		try {
			...
			while ( (s = br.readLine()) != null) {
				...
				if (params[0].equals("networklevel")) {
		...
		//System.out.println ("Network Level Port: "+ resource_manager_port );
	}
	
	public void sendingRequest (String _localhost){
		try{
			//System.out.println( "Inicia Network Level Socket Client Registration" );
			...
			sendStream.writeObject(_localhost);		//We are sending IP address of this resource					
